...
CREATE TABLE `cardapios` (
  `i_cardapio` bigint(20) NOT NULL AUTO_INCREMENT,
  `descricao` varchar(255) DEFAULT NULL,
  `i_pizzaria` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`i_cardapio`),
  KEY `FK_3qw02uf1sbymc94bhigy54jsq` (`i_pizzaria`),
  CONSTRAINT `FK_3qw02uf1sbymc94bhigy54jsq` FOREIGN KEY (`i_pizzaria`) REFERENCES `pizzarias` (`i_pizzaria`)
