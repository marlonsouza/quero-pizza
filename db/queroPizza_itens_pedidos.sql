...
CREATE TABLE `itens_pedidos` (
  `pedido_item` bigint(20) NOT NULL,
  `item_pedido` bigint(20) NOT NULL,
  UNIQUE KEY `UK_auu2dh2syvb8720jgdtv6miq3` (`item_pedido`),
  KEY `FK_m880u2qhi0wwu6axohykqh17y` (`pedido_item`),
  CONSTRAINT `FK_auu2dh2syvb8720jgdtv6miq3` FOREIGN KEY (`item_pedido`) REFERENCES `itens` (`i_item`),
  CONSTRAINT `FK_m880u2qhi0wwu6axohykqh17y` FOREIGN KEY (`pedido_item`) REFERENCES `pedidos` (`i_pedido`)
